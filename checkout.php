            ...
            <div id="customer_details" class="col2-set">
                <div class="col-1">
                    <div class="woocommerce-billing-fields">
                        ...
                        <h2 id="shipping-address">
                            <label class="checkbox" for="ship-to-different-address-checkbox">Please tick to add
                                shipping
                                address</label>
                            <input type="checkbox" value="0" name="ship_to_different_address" checked="0"

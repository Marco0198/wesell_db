...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class=".col-md-12">
                <h2 id="order_review_heading" class="text-center">Billing Details </h2>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="single-sidebar">
                    <h2 class="sidebar-title" class="text-center">Products</h2>
                    <div class="thubmnail-recent">
                        <img src="https://fakestoreapi.com/img/71YXzeOuslL._AC_UY879_.jpg" class="recent-thumb" alt="">
                        <h2><a href="single-product.html">Slim Fit T-Shirts </a></h2>
                        <div class="product-sidebar-price">
                            <ins>R220.30</ins>
                        </div>
                    </div>
                    <div class="thubmnail-recent">
                        <img src="https://fakestoreapi.com/img/71li-ujtlUL._AC_UX679_.jpg" class="recent-thumb" alt="">
                        <h2><a href="single-product.html">Men's Cotton Jacket</a></h2>
                        <div class="product-sidebar-price">
                            <ins>R755.99</ins>
                        </div>
                    </div>
                    ...
                    <div class="thubmnail-recent">
                        <img src="https://fakestoreapi.com/img/71pWzhdJNwL._AC_UL640_QL65_ML3_.jpg" class="recent-thumb"
                            alt="">
                        <h2><a href="single-product.html">Silver Dragon Station Chain Bracelet</a></h2>
                        <div class="product-sidebar-price">
                            <ins>R6950.00</ins>
                        </div>
                    </div>
                    <div class="thubmnail-recent">
                        <img src="https://fakestoreapi.com/img/51UDEzMJVpL._AC_UL640_QL65_ML3_.jpg" class="recent-thumb"
                            alt="">
                        <h2><a href="single-product.html"> Rose Gold Plated Stainless </a></h2>
                        <div class="product-sidebar-price">
                            <ins>R140.99</ins>
                        </div>
                    </div>
                    ...
                    <div class="thubmnail-recent">
                        <img src="https://fakestoreapi.com/img/61pHAEJ4NML._AC_UX679_.jpg" class="recent-thumb" alt="">
                        <h2><a href="single-product.html">DANVOUY Women's T-Shirt </a></h2>
                        <div class="product-sidebar-price">
                            <ins>R212.99</ins>
                        </div>
                    </div>
                ...
                <div id="customer_details" class="col2-set">
                    <div class="col-1">
                        <div class="woocommerce-billing-fields">
                            <form action="bill.php" class="checkout" method="post">
                                ...
                                <p id="billing_state_field" class="form-row form-row-first address-field validate-state"
                                    ...
                                    <input type="text" id="billing_state" name="billing_state" placeholder="Province"
                            ...
                            <h3 id="ship-to-different-address">
                                <label class="checkbox" for="ship-to-different-address-checkbox">Shipping
                                    address?</label>
                                ...
                                <form action="payment.php" method="post">
                                    <ul class="payment_methods methods">
                                        <li class="payment_method_bacs">
                                            <input type="radio" data-order_button_text="" name="payment_method"
                                                checked="checked" value="bacs" name="payment_method" class="input-radio"
                                    ...
                                    <div class="shipping_address" style="display: block;">
                                        ...
                                        <p id="shipping_company_field" class="form-row form-row-wide">
                                            <label class="" for="shipping_company">Company
                                                Name</label>
                                            <input type="text" value="" placeholder="Optional" id="shipping_company"
                                        ...
                                        <p id="shipping_address_1_field"
                                            ...
                                            <input type="text" value="" placeholder="Street address"
                                                id="shipping_address_1" name="shipping_address_1" class="input-text ">
                                        </p>
                                        ...
                                        <p id="shipping_state_field"
                                            ...
                                            <input type="text" id="shipping_state" name="shipping_state"
                                                placeholder="Province" value="" class="input-text ">
                                        </p>
                                        <p id="shipping_phone_field"
                                            class="form-row form-row-first address-field validate-phone"
                                            data-o_class="form-row form-row-first address-field validate-phone">
                                            <label class="" for="shipping_phone">Phone</label>
                                            <input type="text" id="shipping_phone" name="shipping_phone"
                                                placeholder="Phone number" value="" class="input-text ">
                                        </p>

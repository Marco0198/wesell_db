...
<body>
    ...
    <div class="bill-form">
        ...
        <form action="" method="POST">
            ...
            <br>
            <input type="text" name="billing_address_1" placeholder="street address" required>
            <br>
            <input type="text" name="billing_address_2" placeholder="apartment">
            <br>
            <input type="text" name="billing_city" placeholder="town" required>
            <br>
            <input type="text" name="billing_state" placeholder="province" required>
            <br>
            <input type="text" name="billing_postcode" placeholder="postcode" required>
            <br>
            <input type="text" name="billing_email" placeholder="email" required>
            <br>
